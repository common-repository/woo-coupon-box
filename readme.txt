...
- **Minimize the bar**: If customers skip the pop-up, you can select to hide the pop-up or minimize it into the top bar or button of your page.
...
- **Unlimited design options**: Header style, close icon, Google font,...
- **Email plugin compatibility**: The premium version is compatible with WooCommerce Email Template Customizer plugin
...
[Thank You Page Customizer for WooCommerce](http://bit.ly/woo-thank-you-page-customizer): Customize your â€œThank Youâ€ page and give coupons to customers after a successful order
...
### 3rd party services
- Protecting forms from spam and abuse by using Google's reCAPTCHA service.
&#9658; [Google reCAPTCHA](https://www.google.com/recaptcha)
&#9658; [Google reCAPTCHA Terms of Service](https://policies.google.com/terms)
- Integrating with Mailchimp for email marketing campaigns
&#9658; [Mailchimp](https://mailchimp.com/)
&#9658; [Mailchimp Standard Terms of Use](https://mailchimp.com/legal/terms/)

### Documentation

- [Getting Started](http://docs.villatheme.com/woo-coupon-box/)
...
1. Upload `woo-coupon-box` to the `/wp-content/plugins/` directory
...
**2.0.0.6 - 2019.02.25**
- Fixed: Coupon not saved when customers subscribe with shortcode [wcb_widget]
