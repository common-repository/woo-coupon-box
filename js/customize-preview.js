jQuery(document).ready(function ($) {
	'use strict'
	// Create style controlling element
	var fragment = $(document.createDocumentFragment())
	fragment.append($('<style id="woo-coupon-box-custom-css" type="text/css"></style>'))
	fragment.append($('<style id="woo-coupon-box-custom-input-border-radius" type="text/css"></style>'))
...
(function ($) {
	...
	api('woo_coupon_box_params[wcb_layout]', function (value) {
	...
	api('woo_coupon_box_params[wcb_button_close_color]', function (value) {
		value.bind(function (newval) {
			$('.wcb-coupon-box .wcb-md-close').css({ 'color': newval })
		})
	})
	api('woo_coupon_box_params[wcb_button_close_bg_color]', function (value) {
		value.bind(function (newval) {
			$('.wcb-coupon-box .wcb-md-close').css({ 'background-color': newval })
		})
	})
	api('woo_coupon_box_params[wcb_button_close_size]', function (value) {
		value.bind(function (newval) {
			$('.wcb-coupon-box .wcb-md-close').css({ 'font-size': newval + 'px' })
		})
	})
	api('woo_coupon_box_params[wcb_button_close_width]', function (value) {
		value.bind(function (newval) {
	...
	api('woo_coupon_box_params[wcb_button_close_border_radius]', function (value) {
		value.bind(function (newval) {
			$('.wcb-coupon-box .wcb-md-close').css({ 'border-radius': newval + 'px' })
		})
	})
	api('woo_coupon_box_params[wcb_button_close_position_x]', function (value) {
		value.bind(function (newval) {
			newval = -newval
			$('.wcb-coupon-box .wcb-md-close').css({ 'right': newval + 'px' })
		})
	})
	api('woo_coupon_box_params[wcb_button_close_position_y]', function (value) {
		value.bind(function (newval) {
			newval = -newval
	...
	api('woo_coupon_box_params[wcb_view_mode]', function (value) {
		value.bind(function (newval) {
			if (newval === '1') {
	...
	api('woo_coupon_box_params[wcb_title_space]', function (value) {
		value.bind(function (newval) {
			$('.wcb-coupon-box .wcb-modal-header').css({
	...
	api('woo_coupon_box_params[wcb_message]', function (value) {
		value.bind(function (newval) {
			$('.wcb-coupon-box .wcb-coupon-message-before-subscribe').html(newval)
		})
	})

	api('woo_coupon_box_params[wcb_border_radius]', function (value) {
		value.bind(function (newval) {
	...
	api('woo_coupon_box_params[wcb_message_after_subscribe]', function (value) {
		value.bind(function (newval) {
			$('.wcb-coupon-box .wcb-coupon-message-after-subscribe').html(newval)
		})
	})
	api('woo_coupon_box_params[wcb_message_size]', function (value) {
		value.bind(function (newval) {
			$('.wcb-coupon-box .wcb-modal-body .wcb-coupon-message').css('font-size', newval + 'px')
		})
	})
	api('woo_coupon_box_params[wcb_color_message]', function (value) {
		value.bind(function (newval) {
			$('.wcb-coupon-box .wcb-modal-body .wcb-coupon-message').css('color', newval)
		})
	})
	api('woo_coupon_box_params[wcb_message_align]', function (value) {
		value.bind(function (newval) {
			$('.wcb-coupon-box .wcb-modal-body .wcb-coupon-message').css('text-align', newval)
		})
	})

	api('woo_coupon_box_params[wcb_body_bg]', function (value) {
		value.bind(function (newval) {
			$('.wcb-coupon-box .wcb-modal-body').css('backgroundColor', newval)
		})
	})

	api('woo_coupon_box_params[wcb_body_bg_img]', function (value) {
		value.bind(function (newval) {
			$('.wcb-coupon-box .wcb-modal-body').css('background-image', 'url(' + newval + ')')
		})
	})

	api('woo_coupon_box_params[wcb_body_bg_img_repeat]', function (value) {
		value.bind(function (newval) {
			$('.wcb-coupon-box .wcb-modal-body').css('background-repeat', newval)
		})
	})

	api('woo_coupon_box_params[wcb_body_bg_img_size]', function (value) {
		value.bind(function (newval) {
			$('.wcb-coupon-box .wcb-modal-body').css('background-size', newval)
		})
	})

	api('woo_coupon_box_params[wcb_body_bg_img_position]', function (value) {
		value.bind(function (newval) {
			$('.wcb-coupon-box .wcb-modal-body').css('background-position', newval)
		})
	})

	api('woo_coupon_box_params[wcb_body_text_color]', function (value) {
		value.bind(function (newval) {
			$('.wcb-coupon-box .wcb-modal-body').css('color', newval)
		})
	})

	api('woo_coupon_box_params[wcb_button_text]', function (value) {
		value.bind(function (newval) {
			$('.wcb-coupon-box .wcb-newsletter span.wcb-button').html(newval)
		})
	})

	api('woo_coupon_box_params[wcb_button_bg_color]', function (value) {
		value.bind(function (newval) {
			$('.wcb-coupon-box .wcb-newsletter span.wcb-button').css('backgroundColor', newval)
		})
	})
	api('woo_coupon_box_params[wcb_button_border_radius]', function (value) {
		value.bind(function (newval) {
			$('.wcb-coupon-box .wcb-newsletter span.wcb-button').css('border-radius', newval + 'px')
		})
	})
	api('woo_coupon_box_params[wcb_email_input_border_radius]', function (value) {
		value.bind(function (newval) {
			$('.wcb-coupon-box .wcb-newsletter input.wcb-email').css('border-radius', newval + 'px')
		})
	})
	api('woo_coupon_box_params[wcb_email_button_space]', function (value) {
		value.bind(function (newval) {
			$('.wcb-coupon-box .wcb-newsletter input.wcb-email').css('margin-right', newval + 'px')
		})
	})

	api('woo_coupon_box_params[wcb_button_text_color]', function (value) {
		value.bind(function (newval) {
			$('.wcb-coupon-box .wcb-newsletter span.wcb-button').css('color', newval)
		})
	})

	api('woo_coupon_box_params[wcb_footer_text]', function (value) {
		value.bind(function (newval) {
			$('.wcb-footer-text').html(newval)
		})
	})
	api('woo_coupon_box_params[wcb_footer_text_after_subscribe]', function (value) {
		value.bind(function (newval) {
			$('.wcb-footer-text-after-subscribe').html(newval)
		})
	})
	api('woo_coupon_box_params[wcb_show_coupon]', function (value) {
		value.bind(function (newval) {
			if (newval) {
	...
	api('woo_coupon_box_params[wcb_gdpr_checkbox]', function (value) {
		value.bind(function (newval) {
			if (newval) {
				$('.wcb-gdpr-field').show()
			} else {
	...
	api('woo_coupon_box_params[wcb_gdpr_checkbox_checked]', function (value) {
		value.bind(function (newval) {
			if (newval) {
	...
	api('woo_coupon_box_params[wcb_gdpr_message]', function (value) {
		value.bind(function (newval) {
			$('.wcb-gdpr-message').html(newval)
		})
	})

	api('woo_coupon_box_params[alpha_color_overlay]', function (value) {
		value.bind(function (newval) {
			$('body .wcb-md-overlay').css('background', newval)
		})
	})

	api('woo_coupon_box_params[wcb_popup_type]', function (value) {
		value.bind(function (newval) {
	...
	api('woo_coupon_box_params[wcb_color_follow_us]', function (value) {
		value.bind(function (newval) {
			$('.wcb-coupon-box .wcb-text-follow-us').css('color', newval)
		})
	})

	api('woo_coupon_box_params[wcb_follow_us]', function (value) {
		value.bind(function (newval) {
	...
	/*Social*/
	api('woo_coupon_box_params[wcb_social_icons_size]', function (value) {
		value.bind(function (newval) {
			$('.wcb-social-icon').
				css({
					'font-size': newval + 'px',
	...
	api('woo_coupon_box_params[wcb_social_icons_target]', function (value) {
		value.bind(function (newval) {
			jQuery('.wcb-social-button').attr('target', newval)
		})
	})
	//facebook
	api('woo_coupon_box_params[wcb_social_icons_facebook_url]', function (value) {
		value.bind(function (newval) {
	...
	api('woo_coupon_box_params[wcb_social_icons_facebook_color]', function (value) {
		value.bind(function (newval) {
	...
	//twitter
	api('woo_coupon_box_params[wcb_social_icons_twitter_url]', function (value) {
		value.bind(function (newval) {
	...
	api('woo_coupon_box_params[wcb_social_icons_twitter_color]', function (value) {
		value.bind(function (newval) {
			jQuery('.wcb-twitter-follow span').css({ 'color': newval })
		})
	})
	//pinterest
	api('woo_coupon_box_params[wcb_social_icons_pinterest_url]', function (value) {
		value.bind(function (newval) {
	...
	api('woo_coupon_box_params[wcb_social_icons_pinterest_color]', function (value) {
		value.bind(function (newval) {
			jQuery('.wcb-pinterest-follow span').css({ 'color': newval })
		})
	})
	//instagram
	api('woo_coupon_box_params[wcb_social_icons_instagram_url]', function (value) {
		value.bind(function (newval) {
	...
	api('woo_coupon_box_params[wcb_social_icons_instagram_color]', function (value) {
		value.bind(function (newval) {
			jQuery('.wcb-instagram-follow span').css({ 'color': newval })
		})
	})
	//dribbble
	api('woo_coupon_box_params[wcb_social_icons_dribbble_url]', function (value) {
		value.bind(function (newval) {
	...
	api('woo_coupon_box_params[wcb_social_icons_dribbble_color]', function (value) {
		value.bind(function (newval) {
			jQuery('.wcb-dribbble-follow span').css({ 'color': newval })
		})
	})
	//tumblr
	api('woo_coupon_box_params[wcb_social_icons_tumblr_url]', function (value) {
		value.bind(function (newval) {
	...
	api('woo_coupon_box_params[wcb_social_icons_tumblr_color]', function (value) {
		value.bind(function (newval) {
			jQuery('.wcb-tumblr-follow span').css({ 'color': newval })
		})
	})
	//google
	api('woo_coupon_box_params[wcb_social_icons_google_url]', function (value) {
		value.bind(function (newval) {
	...
	api('woo_coupon_box_params[wcb_social_icons_google_color]', function (value) {
		value.bind(function (newval) {
	...
	//vkontakte
	api('woo_coupon_box_params[wcb_social_icons_vkontakte_url]', function (value) {
		value.bind(function (newval) {
	...
	api('woo_coupon_box_params[wcb_social_icons_vkontakte_color]', function (value) {
		value.bind(function (newval) {
			jQuery('.wcb-vkontakte-follow span').css({ 'color': newval })
		})
	})
	//linkedin
	api('woo_coupon_box_params[wcb_social_icons_linkedin_url]', function (value) {
		value.bind(function (newval) {
	...
	api('woo_coupon_box_params[wcb_social_icons_linkedin_color]', function (value) {
		value.bind(function (newval) {
			jQuery('.wcb-linkedin-follow span').css({ 'color': newval })
		})
	})
	//youtube
	api('woo_coupon_box_params[wcb_social_icons_youtube_url]', function (value) {
		value.bind(function (newval) {
	...
	api('woo_coupon_box_params[wcb_social_icons_youtube_color]', function (value) {
		value.bind(function (newval) {
			jQuery('.wcb-youtube-follow span').css({ 'color': newval })
		})
	})

	api('woo_coupon_box_params[wcb_custom_css]', function (value) {
		value.bind(function (newval) {
	...
	api('woo_coupon_box_params[wcb_popup_icon_enable]', function (value) {
		value.bind(function (newval) {
			if (newval) {
				if (jQuery('.wcb-coupon-box-small-icon-wrap').hasClass('wcb-coupon-box-small-icon-position-bottom-left') ||
					jQuery('.wcb-coupon-box-small-icon-wrap').hasClass('wcb-coupon-box-small-icon-position-top-left')) {
	...
	api('woo_coupon_box_params[wcb_popup_icon_position]', function (value) {
		value.bind(function (newval) {
			jQuery('.wcb-coupon-box-small-icon-wrap').
				removeClass('wcb-coupon-box-small-icon-position-top-right').
				removeClass('wcb-coupon-box-small-icon-position-bottom-right').
				removeClass('wcb-coupon-box-small-icon-position-top-left').
				removeClass('wcb-coupon-box-small-icon-position-bottom-left').
				addClass('wcb-coupon-box-small-icon-position-' + newval)
		})
	})
	api('woo_coupon_box_params[wcb_popup_icon_mobile]', function (value) {
		value.bind(function (newval) {
			if (newval) {
	...
	api('woo_coupon_box_params[wcb_popup_icon_size]', function (value) {
		value.bind(function (newval) {
			jQuery('.wcb-coupon-box-small-icon').
				css({
					'font-size': newval + 'px',
					'line-height': newval + 'px',
				})
	...
	api('woo_coupon_box_params[wcb_popup_icon_border_radius]', function (value) {
		value.bind(function (newval) {
			jQuery('.wcb-coupon-box-small-icon-wrap').css({ 'border-radius': newval + 'px' })
		})
	})
	api('woo_coupon_box_params[wcb_popup_icon_color]', function (value) {
		value.bind(function (newval) {
			jQuery('.wcb-coupon-box-small-icon').css('color', newval)
		})
	})
	api('woo_coupon_box_params[wcb_popup_icon_bg_color]', function (value) {
		value.bind(function (newval) {
	...
	/* button 'no, thanks' */
	api('woo_coupon_box_params[wcb_no_thank_button_enable]', function (value) {
		value.bind(function (newval) {
			if (newval) {
	...
	api('woo_coupon_box_params[wcb_no_thank_button_title]', function (value) {
		value.bind(function (newval) {
			jQuery('.wcb-md-close-never-reminder').html(newval)
		})
	})
	api('woo_coupon_box_params[wcb_no_thank_button_border_radius]', function (value) {
		value.bind(function (newval) {
			jQuery('.wcb-md-close-never-reminder').css({ 'border-radius': newval + 'px' })
		})
	})
	api('woo_coupon_box_params[wcb_no_thank_button_color]', function (value) {
		value.bind(function (newval) {
			jQuery('.wcb-md-close-never-reminder').css({ 'color': newval })
		})
	})
	api('woo_coupon_box_params[wcb_no_thank_button_bg_color]', function (value) {
		value.bind(function (newval) {
