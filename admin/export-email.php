...
class VI_WOO_COUPON_BOX_Admin_Export_Email {
    ...
    public function menu_options() {
        add_submenu_page( 'edit.php?post_type=wcb', esc_html__( 'Export Email', 'woo-coupon-box' ), esc_html__( 'Export Email', 'woo-coupon-box' ), 'manage_options', 'woo_coupon_box_export_email', array( $this, 'setting_page_export' ) );
    }
    ...
    public function admin_enqueue_script() {
        ...
        wp_enqueue_script( 'woo-coupon-box-export-form', VI_WOO_COUPON_BOX_JS . 'form.min.js', array( 'jquery' ), VI_WOO_COUPON_BOX_VERSION, true );
