...
class VI_WOO_COUPON_BOX_Admin_Design {
    ...
    public function customize_controls_enqueue_scripts() {
        ...
        wp_enqueue_script( 'woo-coupon-box-customize-setting', VI_WOO_COUPON_BOX_JS . 'customize-setting.js', array( 'jquery' ), VI_WOO_COUPON_BOX_VERSION, true );
    }
    ...
    public function customize_preview_init() {
        ...
        if ( $this->settings->get_params( 'wcb_recaptcha' ) ) {
            if ( $this->settings->get_params( 'wcb_recaptcha_version' ) == 2 ) {
                $script_url = "https://www.google.com/recaptcha/api.js?hl=" . esc_attr( get_locale() ) . "&render=explicit";
                wp_enqueue_script( 'wcb_recaptcha_api', $script_url, array(), VI_WOO_COUPON_BOX_VERSION, true );
            } elseif ( $this->settings->get_params( 'wcb_recaptcha_site_key' ) ) {
                $site_key   = esc_attr( $this->settings->get_params( 'wcb_recaptcha_site_key' ) );
                $script_url = "https://www.google.com/recaptcha/api.js?hl=" . esc_attr( get_locale() ) . "&render=" . $site_key;
                wp_enqueue_script( 'wcb_recaptcha_api', $script_url, array(), VI_WOO_COUPON_BOX_VERSION, true );
            }
        }
    }
    ...
    public function design_option_customizer( $wp_customize ) {
        $wp_customize->add_panel( 'wcb_coupon_box_design', array(
            ...
            'theme_supports' => '',
            'title'          => esc_html__( 'Coupon Box for WooCommerce', 'woo-coupon-box' ),
        ) );
    ...
    protected function add_section_design_pro_version_features( $wp_customize ) {
        $wp_customize->add_section( 'wcb_coupon_box_design_pro_version_features', array(
            ...
            'capability'     => 'manage_options',
            'theme_supports' => '',
            'title'          => esc_html__( 'Premium version features', 'woo-coupon-box' ),
        ...
        $wp_customize->add_control( new WOO_COUPON_BOX_Lists( $wp_customize, 'woo_coupon_box_params[wcb_pro_version_features]', array(
            'label'   => 'Premium features',
            'section' => 'wcb_coupon_box_design_pro_version_features',
            'choices' => array(
	            esc_html__( 'More triggers to show coupon box', 'woo-coupon-box' ),
	            esc_html__( 'More option when visitors close Coupon box', 'woo-coupon-box' ),
	            esc_html__( 'More input fields including name, mobile, birthday and gender', 'woo-coupon-box' ),
	            esc_html__( 'Background effect like snow, rain...', 'woo-coupon-box' ),
	            esc_html__( 'More templates to choose', 'woo-coupon-box' ),
	            esc_html__( 'Google font', 'woo-coupon-box' ),
	            esc_html__( 'ActiveCampaign integrated', 'woo-coupon-box' ),
	            esc_html__( 'Premium support', 'woo-coupon-box' ),
            ),
        ) ) );
    }
    ...
    protected function add_section_design_general( $wp_customize ) {
        $wp_customize->add_section( 'wcb_coupon_box_design_general', array(
            ...
            'capability'     => 'manage_options',
            'theme_supports' => '',
            'title'          => esc_html__( 'General', 'woo-coupon-box' ),
            'panel'          => 'wcb_coupon_box_design',
        ) );
        ...
        $wp_customize->add_control( 'woo_coupon_box_params[wcb_view_mode]', array(
            ...
            'label'       => esc_html__( 'Select view mode to edit', 'woo-coupon-box' ),
            'choices'     => array(
                '1' => esc_html__( 'Before subscribe', 'woo-coupon-box' ),
                '2' => esc_html__( 'After subscribe', 'woo-coupon-box' ),
            ),
            'description' => esc_html__( 'This option is for you to see what it\'t like before and after visitors subscribe only', 'woo-coupon-box' ),
        ) );
        ...
        $wp_customize->add_control( 'woo_coupon_box_params[wcb_show_coupon]', array(
            'type'        => 'checkbox',
            'section'     => 'wcb_coupon_box_design_general',
            'label'       => esc_html__( 'Show coupon after subscribing.', 'woo-coupon-box' ),
            'description' => esc_html__( 'If you set to give coupons for subscribers, beside sending coupon code via email address, enable this to print out the coupon code inside the coupon box after subscribing.', 'woo-coupon-box' ),
        ) );
        ...
        $wp_customize->add_control( 'woo_coupon_box_params[wcb_border_radius]', array(
            'type'        => 'number',
            'section'     => 'wcb_coupon_box_design_general',
            'label'       => esc_html__( 'Coupon Box Rounded Corner (px)', 'woo-coupon-box' ),
            'input_attrs' => array(
                'min'  => 0,
                'step' => 1,
            ),
        ...
        $wp_customize->add_control( 'woo_coupon_box_params[wcb_popup_type]', array(
            ...
            'label'   => esc_html__( 'Popup Display Type', 'woo-coupon-box' ),
            'choices' => array(
        ...
        $wp_customize->add_control( new WOO_COUPON_BOX_Alpha_Color_Control( $wp_customize, 'woo_coupon_box_params[alpha_color_overlay]', array(
            'label'        => esc_html__( 'Overlay color', 'woo-coupon-box' ),
            'section'      => 'wcb_coupon_box_design_general',
        ...
        $wp_customize->add_control( 'woo_coupon_box_params[wcb_gdpr_checkbox]', array(
            'type'    => 'checkbox',
            'section' => 'wcb_coupon_box_design_general',
            'label'   => esc_html__( 'GDPR checkbox', 'woo-coupon-box' ),
        ) );
        ...
        $wp_customize->add_control( 'woo_coupon_box_params[wcb_gdpr_checkbox_checked]', array(
            'type'    => 'checkbox',
            'section' => 'wcb_coupon_box_design_general',
            'label'   => esc_html__( 'Set checkbox state "checked" as default', 'woo-coupon-box' ),
        ) );
        ...
        $wp_customize->add_control( 'woo_coupon_box_params[wcb_gdpr_message]', array(
            ...
            'priority' => 10,
            'section'  => 'wcb_coupon_box_design_general',
            'label'    => esc_html__( 'GDPR message', 'woo-coupon-box' ),
        ) );
        ...
        $wp_customize->add_control( 'woo_coupon_box_params[wcb_no_thank_button_enable]', array(
            'type'    => 'checkbox',
            'section' => 'wcb_coupon_box_design_general',
            'label'   => esc_html__( 'Button \'No, thanks\'', 'woo-coupon-box' ),
        ) );
        ...
        $wp_customize->add_control( 'woo_coupon_box_params[wcb_no_thank_button_title]', array(
            ...
            'priority' => 10,
            'section'  => 'wcb_coupon_box_design_general',
            'label'    => esc_html__( 'Button title', 'woo-coupon-box' ),
        ) );
        ...
        $wp_customize->add_control( 'woo_coupon_box_params[wcb_no_thank_button_border_radius]', array(
            'type'        => 'number',
            'section'     => 'wcb_coupon_box_design_general',
            'label'       => esc_html__( 'Rounded corner (px)', 'woo-coupon-box' ),
            'input_attrs' => array(
                'min'  => 0,
                'step' => 1,
            ),
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'woo_coupon_box_params[wcb_no_thank_button_color]', array(
            'label'    => esc_html__( 'Button title color', 'woo-coupon-box' ),
            'section'  => 'wcb_coupon_box_design_general',
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'woo_coupon_box_params[wcb_no_thank_button_bg_color]', array(
        ...
        $wp_customize->add_control( 'woo_coupon_box_params[wcb_footer_text]', array(
            ...
            'priority' => 10,
            'section'  => 'wcb_coupon_box_design_general',
            'label'    => esc_html__( 'Footer Text', 'woo-coupon-box' ),
        ) );
        ...
        $wp_customize->add_control( 'woo_coupon_box_params[wcb_footer_text_after_subscribe]', array(
            ...
            'priority' => 10,
            'section'  => 'wcb_coupon_box_design_general',
            'label'    => esc_html__( 'Footer Text After Subscribing', 'woo-coupon-box' ),
        ) );
    }
    ...
    public function add_section_design_button_close( $wp_customize ) {
        $wp_customize->add_section( 'wcb_coupon_box_design_button_close', array(
            ...
            'capability'     => 'manage_options',
            'theme_supports' => '',
            'title'          => esc_html__( 'Button Close', 'woo-coupon-box' ),
            'panel'          => 'wcb_coupon_box_design',
        ) );
        ...
        $wp_customize->add_control( new WOO_COUPON_BOX_Radio_Icons_Control( $wp_customize, 'woo_coupon_box_params[wcb_button_close]', array(
            'label'   => 'Icons',
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'woo_coupon_box_params[wcb_button_close_color]', array(
            'label'   => esc_html__( 'Color', 'woo-coupon-box' ),
            'section' => 'wcb_coupon_box_design_button_close',
        ) ) );
        ...
        $wp_customize->add_control( new WOO_COUPON_BOX_Alpha_Color_Control( $wp_customize, 'woo_coupon_box_params[wcb_button_close_bg_color]', array(
            'label'        => esc_html__( 'Background Color', 'woo-coupon-box' ),
            'section'      => 'wcb_coupon_box_design_button_close',
            'show_opacity' => true, // Optional.
            'palette'      => array(
                'rgb(0, 0, 0)',
        ...
        $wp_customize->add_control( 'woo_coupon_box_params[wcb_button_close_size]', array(
            'type'        => 'number',
            'section'     => 'wcb_coupon_box_design_button_close',
            'label'       => esc_html__( 'Size (px)', 'woo-coupon-box' ),
            'input_attrs' => array(
                'min'  => 0,
                'step' => 1,
            ),
        ...
        $wp_customize->add_control( 'woo_coupon_box_params[wcb_button_close_width]', array(
            'type'        => 'number',
            'section'     => 'wcb_coupon_box_design_button_close',
            'label'       => esc_html__( 'Width (px)', 'woo-coupon-box' ),
            'description' => esc_html__( 'Helpful tip: Set width to 0 to disable button close. Visitor can still close Coupon box without subscribing by clicking around or press Esc.', 'woo-coupon-box' ),
            'input_attrs' => array(
                'min'  => 0,
                'step' => 1,
            ),
        ...
        $wp_customize->add_control( 'woo_coupon_box_params[wcb_button_close_position_x]', array(
            'type'    => 'number',
            'section' => 'wcb_coupon_box_design_button_close',
            'label'   => esc_html__( 'Position-x (px)', 'woo-coupon-box' ),
        ) );
        ...
        $wp_customize->add_control( 'woo_coupon_box_params[wcb_button_close_position_y]', array(
            'type'    => 'number',
            'section' => 'wcb_coupon_box_design_button_close',
            'label'   => esc_html__( 'Position-y (px)', 'woo-coupon-box' ),
        ) );
    }
    ...
    public function add_section_design_header( $wp_customize ) {
        $wp_customize->add_section( 'wcb_coupon_box_design_header', array(
            ...
            'capability'     => 'manage_options',
            'theme_supports' => '',
            'title'          => esc_html__( 'Header', 'woo-coupon-box' ),
            'panel'          => 'wcb_coupon_box_design',
        ) );
        ...
        if ( $this->settings->get_params( 'wcb_layout' ) == 3 ) {
            $wp_customize->add_control( 'woo_coupon_box_params[wcb_title]', array(
                ...
                'label'       => esc_html__( 'Header Title', 'woo-coupon-box' ),
                'description' => wp_kses_post( esc_html__( 'Place words in <span></span> to make it display in new line', 'woo-coupon-box' ) ),
            ) );
        } else {
            $wp_customize->add_control( 'woo_coupon_box_params[wcb_title]', array(
                'type'     => 'textarea',
        ...
        $wp_customize->add_control( 'woo_coupon_box_params[wcb_title_after_subscribing]', array(
            ...
            'priority' => 10,
            'section'  => 'wcb_coupon_box_design_header',
            'label'    => esc_html__( 'Header Title After Subscribe', 'woo-coupon-box' ),
        ) );
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'woo_coupon_box_params[wcb_color_header]', array(
            'label'    => esc_html__( 'Header Color', 'woo-coupon-box' ),
            'section'  => 'wcb_coupon_box_design_header',
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'woo_coupon_box_params[wcb_bg_header]', array(
            'label'    => esc_html__( 'Header Background Color', 'woo-coupon-box' ),
            'section'  => 'wcb_coupon_box_design_header',
        ...
        $wp_customize->add_control( 'woo_coupon_box_params[wcb_title_size]', array(
            'type'        => 'number',
            'section'     => 'wcb_coupon_box_design_header',
            'label'       => esc_html__( 'Header Font Size(px)', 'woo-coupon-box' ),
            'description' => esc_html__( 'Helpful tip: Set both Header Font size and Space to 0 to hide header.', 'woo-coupon-box' ),
            'input_attrs' => array(
                'min'  => 0,
                'step' => 1,
            ),
        ...
        $wp_customize->add_control( 'woo_coupon_box_params[wcb_title_space]', array(
            'type'        => 'number',
            'section'     => 'wcb_coupon_box_design_header',
            'label'       => esc_html__( 'Header Space(px)', 'woo-coupon-box' ),
            'input_attrs' => array(
                'min'  => 0,
                'step' => 1,
            ),
    ...
    public function add_section_design_body( $wp_customize ) {
        $wp_customize->add_section( 'wcb_coupon_box_design_body', array(
            ...
            'capability'     => 'manage_options',
            'theme_supports' => '',
            'title'          => esc_html__( 'Body', 'woo-coupon-box' ),
            'panel'          => 'wcb_coupon_box_design',
        ) );
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'woo_coupon_box_params[wcb_body_text_color]', array(
            'label'    => esc_html__( 'Body Text Color', 'woo-coupon-box' ),
            'section'  => esc_html__( 'wcb_coupon_box_design_body', 'woo-coupon-box' ),
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'woo_coupon_box_params[wcb_body_bg]', array(
            'label'    => esc_html__( 'Body Background Color', 'woo-coupon-box' ),
        ...
        $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'woo_coupon_box_params[wcb_body_bg_img]', array(
            'label'    => esc_html__( 'Body Background Image', 'woo-coupon-box' ),
            'section'  => 'wcb_coupon_box_design_body',
        ...
        $wp_customize->add_control( 'woo_coupon_box_params[wcb_body_bg_img_repeat]', array(
            ...
            'label'   => esc_html__( 'Body Background Image Repeat', 'woo-coupon-box' ),
            'choices' => array(
                'inherit'   => esc_html__( 'inherit', 'woo-coupon-box' ),
                'no-repeat' => esc_html__( 'no-repeat', 'woo-coupon-box' ),
                'repeat'    => esc_html__( 'repeat', 'woo-coupon-box' ),
                'repeat-x'  => esc_html__( 'repeat-x', 'woo-coupon-box' ),
                'repeat-y'  => esc_html__( 'repeat-y', 'woo-coupon-box' ),
                'round'     => esc_html__( 'round', 'woo-coupon-box' ),
                'space'     => esc_html__( 'space', 'woo-coupon-box' ),
            ),
        ) );
        ...
        $wp_customize->add_control( 'woo_coupon_box_params[wcb_body_bg_img_size]', array(
            'type'    => 'select',
            'section' => 'wcb_coupon_box_design_body', // Add a default or your own section
            'label'   => esc_html__( 'Body Background Image Size', 'woo-coupon-box' ),
            'choices' => array(
                'auto'    => esc_html__( 'Auto', 'woo-coupon-box' ),
                'inherit' => esc_html__( 'Inherit', 'woo-coupon-box' ),
                'contain' => esc_html__( 'Contain', 'woo-coupon-box' ),
                'cover'   => esc_html__( 'Cover', 'woo-coupon-box' ),
            ),
        ) );
        ...
        $wp_customize->add_control( 'woo_coupon_box_params[wcb_body_bg_img_position]', array(
            'type'        => 'text',
            'section'     => 'wcb_coupon_box_design_body', // Add a default or your own section
            'label'       => esc_html__( 'Body Background Image Position', 'woo-coupon-box' ),
            'description' => esc_html__( 'Position of Background Image. Eg: 100% 100%, center...', 'woo-coupon-box' ),
        ) );
        ...
        $wp_customize->add_control( 'woo_coupon_box_params[wcb_message]', array(
            ...
            'priority' => 10,
            'section'  => 'wcb_coupon_box_design_body',
            'label'    => esc_html__( 'Message', 'woo-coupon-box' ),
        ) );
        ...
        $wp_customize->add_control( 'woo_coupon_box_params[wcb_message_after_subscribe]', array(
            ...
            'priority' => 10,
            'section'  => 'wcb_coupon_box_design_body',
            'label'    => esc_html__( 'Message After Subscribing', 'woo-coupon-box' ),
        ) );
        ...
        $wp_customize->add_control( 'woo_coupon_box_params[wcb_message_size]', array(
            'type'        => 'number',
            'section'     => 'wcb_coupon_box_design_body',
            'label'       => esc_html__( 'Message Size (px)', 'woo-coupon-box' ),
            'input_attrs' => array(
                'min'  => 0,
                'step' => 1,
            ),
        ...
        $wp_customize->add_control( 'woo_coupon_box_params[wcb_message_align]', array(
            'type'    => 'select',
            'section' => 'wcb_coupon_box_design_body',
            'label'   => esc_html__( 'Message Text Align (px)', 'woo-coupon-box' ),
            'choices' => array(
                'left'    => esc_html__( 'Left', 'woo-coupon-box' ),
                'center'  => esc_html__( 'Center', 'woo-coupon-box' ),
                'right'   => esc_html__( 'Right', 'woo-coupon-box' ),
                'justify' => esc_html__( 'Justify', 'woo-coupon-box' ),
                'start'   => esc_html__( 'Start', 'woo-coupon-box' ),
                'end'     => esc_html__( 'End', 'woo-coupon-box' ),
            ),
        ) );
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'woo_coupon_box_params[wcb_color_message]', array(
            'label'    => esc_html__( 'Message Color', 'woo-coupon-box' ),
            'section'  => 'wcb_coupon_box_design_body',
    ...
    public function add_section_design_social( $wp_customize ) {
        $wp_customize->add_section( 'wcb_coupon_box_design_social', array(
            ...
            'capability'     => 'manage_options',
            'theme_supports' => '',
            'title'          => esc_html__( 'Social Media', 'woo-coupon-box' ),
            'panel'          => 'wcb_coupon_box_design',
        ) );
        $icons = array(
        ...
        $wp_customize->add_control( 'woo_coupon_box_params[wcb_follow_us]', array(
            ...
            'label'    => esc_html__( 'Text Follow Social Network', 'woo-coupon-box' ),
        ) );
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'woo_coupon_box_params[wcb_color_follow_us]', array(
            'label'    => esc_html__( 'Follow Us Text Color', 'woo-coupon-box' ),
            'section'  => 'wcb_coupon_box_design_social',
        ...
        $wp_customize->add_control( 'woo_coupon_box_params[wcb_social_icons_size]', array(
            'type'        => 'number',
            'section'     => 'wcb_coupon_box_design_social',
            'label'       => esc_html__( 'Icons size (px)', 'woo-coupon-box' ),
            'input_attrs' => array(
                'min'  => 0,
                'step' => 1,
            ),
        ...
        $wp_customize->add_control( 'woo_coupon_box_params[wcb_social_icons_target]', array(
            'type'    => 'select',
            'section' => 'wcb_coupon_box_design_social',
            'label'   => esc_html__( 'When click on social icons', 'woo-coupon-box' ),
            'choices' => array(
                '_blank' => esc_html__( 'Open link in new tab', 'woo-coupon-box' ),
        ...
        $wp_customize->add_control( 'woo_coupon_box_params[wcb_social_icons_facebook_url]', array(
            'type'        => 'url',
            'section'     => 'wcb_coupon_box_design_social',
            'label'       => esc_html__( 'Facebook User Name', 'woo-coupon-box' ),
            'description' => esc_html__( 'Your Facebook User Name. Eg: villatheme', 'woo-coupon-box' ),
        ) );
        ...
        $wp_customize->add_control( new WOO_COUPON_BOX_Radio_Icons_Control( $wp_customize, 'woo_coupon_box_params[wcb_social_icons_facebook_select]', array(
            'label'   => 'Icons',
            'section' => 'wcb_coupon_box_design_social',
            'choices' => $facebook,
        ) ) );
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'woo_coupon_box_params[wcb_social_icons_facebook_color]', array(
        ...
        $wp_customize->add_control( 'woo_coupon_box_params[wcb_social_icons_twitter_url]', array(
            'type'        => 'url',
            'section'     => 'wcb_coupon_box_design_social',
            'label'       => esc_html__( 'Twitter User Name', 'woo-coupon-box' ),
            'description' => esc_html__( 'Your Twitter User Name. Eg: villatheme', 'woo-coupon-box' ),
        ) );
        ...
        $wp_customize->add_control( new WOO_COUPON_BOX_Radio_Icons_Control( $wp_customize, 'woo_coupon_box_params[wcb_social_icons_twitter_select]', array(
            'label'   => 'Icons',
            'section' => 'wcb_coupon_box_design_social',
            'choices' => $twitter,
        ) ) );
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'woo_coupon_box_params[wcb_social_icons_twitter_color]', array(
            'label'   => esc_html__( 'Icon Color', 'woo-coupon-box' ),
            'section' => 'wcb_coupon_box_design_social',
        ) ) );
        ...
        $wp_customize->add_control( 'woo_coupon_box_params[wcb_social_icons_pinterest_url]', array(
            'type'        => 'url',
            'section'     => 'wcb_coupon_box_design_social',
            'label'       => esc_html__( 'Pinterest User Name', 'woo-coupon-box' ),
            'description' => esc_html__( 'Your Pinterest User Name. Eg: villatheme', 'woo-coupon-box' ),
        ) );
        ...
        $wp_customize->add_control( new WOO_COUPON_BOX_Radio_Icons_Control( $wp_customize, 'woo_coupon_box_params[wcb_social_icons_pinterest_select]', array(
            'label'   => 'Icons',
            'section' => 'wcb_coupon_box_design_social',
            'choices' => $pinterest,
        ) ) );
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'woo_coupon_box_params[wcb_social_icons_pinterest_color]', array(
            'label'   => esc_html__( 'Icon Color', 'woo-coupon-box' ),
            'section' => 'wcb_coupon_box_design_social',
        ) ) );
        ...
        $wp_customize->add_control( 'woo_coupon_box_params[wcb_social_icons_instagram_url]', array(
            'type'        => 'url',
            'section'     => 'wcb_coupon_box_design_social',
            'label'       => esc_html__( 'Instagram User Name', 'woo-coupon-box' ),
            'description' => esc_html__( 'Your Instagram User Name. Eg: villatheme', 'woo-coupon-box' ),
        ) );
        ...
        $wp_customize->add_control( new WOO_COUPON_BOX_Radio_Icons_Control( $wp_customize, 'woo_coupon_box_params[wcb_social_icons_instagram_select]', array(
            'label'   => 'Icons',
            'section' => 'wcb_coupon_box_design_social',
            'choices' => $instagram,
        ) ) );
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'woo_coupon_box_params[wcb_social_icons_instagram_color]', array(
            'label'   => esc_html__( 'Icon Color', 'woo-coupon-box' ),
            'section' => 'wcb_coupon_box_design_social',
        ) ) );
        ...
        $wp_customize->add_control( 'woo_coupon_box_params[wcb_social_icons_dribbble_url]', array(
            'type'        => 'url',
            'section'     => 'wcb_coupon_box_design_social',
            'label'       => esc_html__( 'Dribbble User Name', 'woo-coupon-box' ),
            'description' => esc_html__( 'Your Dribbble User Name. Eg: villatheme', 'woo-coupon-box' ),
        ) );
        ...
        $wp_customize->add_control( new WOO_COUPON_BOX_Radio_Icons_Control( $wp_customize, 'woo_coupon_box_params[wcb_social_icons_dribbble_select]', array(
            'label'   => 'Icons',
            'section' => 'wcb_coupon_box_design_social',
            'choices' => $dribbble,
        ) ) );
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'woo_coupon_box_params[wcb_social_icons_dribbble_color]', array(
            'label'   => esc_html__( 'Icon Color', 'woo-coupon-box' ),
            'section' => 'wcb_coupon_box_design_social',
        ) ) );
        ...
        $wp_customize->add_control( 'woo_coupon_box_params[wcb_social_icons_tumblr_url]', array(
            'type'        => 'url',
            'section'     => 'wcb_coupon_box_design_social',
            'label'       => esc_html__( 'Tumblr User Name', 'woo-coupon-box' ),
            'description' => esc_html__( 'Your Tumblr User Name. Eg: villatheme', 'woo-coupon-box' ),
        ) );
        ...
        $wp_customize->add_control( new WOO_COUPON_BOX_Radio_Icons_Control( $wp_customize, 'woo_coupon_box_params[wcb_social_icons_tumblr_select]', array(
            'label'   => 'Icons',
            'section' => 'wcb_coupon_box_design_social',
            'choices' => $tumblr,
        ) ) );
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'woo_coupon_box_params[wcb_social_icons_tumblr_color]', array(
            'label'   => esc_html__( 'Icon Color', 'woo-coupon-box' ),
            'section' => 'wcb_coupon_box_design_social',
        ) ) );
        ...
        $wp_customize->add_control( 'woo_coupon_box_params[wcb_social_icons_google_url]', array(
            'type'        => 'url',
            'section'     => 'wcb_coupon_box_design_social',
            'label'       => esc_html__( 'Google Plus ID', 'woo-coupon-box' ),
            'description' => esc_html__( 'Your Google Plus ID. Eg: +LarryPage', 'woo-coupon-box' ),
        ) );
        ...
        $wp_customize->add_control( new WOO_COUPON_BOX_Radio_Icons_Control( $wp_customize, 'woo_coupon_box_params[wcb_social_icons_google_select]', array(
            'label'   => 'Icons',
            'section' => 'wcb_coupon_box_design_social',
            'choices' => $google,
        ) ) );
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'woo_coupon_box_params[wcb_social_icons_google_color]', array(
            'label'   => esc_html__( 'Icon Color', 'woo-coupon-box' ),
            'section' => 'wcb_coupon_box_design_social',
        ) ) );
        ...
        $wp_customize->add_control( 'woo_coupon_box_params[wcb_social_icons_vkontakte_url]', array(
            'type'        => 'url',
            'section'     => 'wcb_coupon_box_design_social',
            'label'       => esc_html__( 'VKontakte User Name', 'woo-coupon-box' ),
            'description' => esc_html__( 'Your VKontakte User Name. Eg: villatheme', 'woo-coupon-box' ),
        ) );
        ...
        $wp_customize->add_control( new WOO_COUPON_BOX_Radio_Icons_Control( $wp_customize, 'woo_coupon_box_params[wcb_social_icons_vkontakte_select]', array(
            'label'   => 'Icons',
            'section' => 'wcb_coupon_box_design_social',
            'choices' => $vkontakte,
        ) ) );
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'woo_coupon_box_params[wcb_social_icons_vkontakte_color]', array(
            'label'   => esc_html__( 'Icon Color', 'woo-coupon-box' ),
            'section' => 'wcb_coupon_box_design_social',
        ) ) );
        ...
        $wp_customize->add_control( new WOO_COUPON_BOX_Radio_Icons_Control( $wp_customize, 'woo_coupon_box_params[wcb_social_icons_linkedin_select]', array(
            'label'   => 'Icons',
            'section' => 'wcb_coupon_box_design_social',
            'choices' => $linkedin,
        ) ) );
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'woo_coupon_box_params[wcb_social_icons_linkedin_color]', array(
            'label'   => esc_html__( 'Icon Color', 'woo-coupon-box' ),
            'section' => 'wcb_coupon_box_design_social',
        ) ) );
        ...
        $wp_customize->add_control( new WOO_COUPON_BOX_Radio_Icons_Control( $wp_customize, 'woo_coupon_box_params[wcb_social_icons_youtube_select]', array(
            'label'   => 'Icons',
            'section' => 'wcb_coupon_box_design_social',
            'choices' => $youtube,
        ) ) );
    ...
    public function add_section_design_button_subscribe( $wp_customize ) {
        $wp_customize->add_section( 'wcb_coupon_box_design_button_subscribe', array(
            ...
            'capability'     => 'manage_options',
            'theme_supports' => '',
            'title'          => esc_html__( 'Button Subscribe & Email field', 'woo-coupon-box' ),
            'panel'          => 'wcb_coupon_box_design',
        ) );
        ...
        $wp_customize->add_control( 'woo_coupon_box_params[wcb_email_input_border_radius]', array(
            ...
            'label'       => esc_html__( 'Emai Input Rounded Corner (px)', 'woo-coupon-box' ),
            'input_attrs' => array(
                'min'  => 0,
                'step' => 1,
            ),
        ...
        $wp_customize->add_control( 'woo_coupon_box_params[wcb_email_button_space]', array(
            'type'        => 'number',
            'section'     => 'wcb_coupon_box_design_button_subscribe',
            'label'       => esc_html__( 'Space between email field & button SUBSCRIBE', 'woo-coupon-box' ),
            'input_attrs' => array(
                'min'  => 0,
                'step' => 1,
            ),
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'woo_coupon_box_params[wcb_button_text_color]', array(
            'label'    => esc_html__( 'Button Text Color', 'woo-coupon-box' ),
            'section'  => 'wcb_coupon_box_design_button_subscribe',
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'woo_coupon_box_params[wcb_button_bg_color]', array(
            'label'    => esc_html__( 'Button Background Color', 'woo-coupon-box' ),
            'section'  => 'wcb_coupon_box_design_button_subscribe',
        ...
        $wp_customize->add_control( 'woo_coupon_box_params[wcb_button_border_radius]', array(
            'type'        => 'number',
            'section'     => 'wcb_coupon_box_design_button_subscribe',
            'label'       => esc_html__( 'Button "SUBSCRIBE" Rounded Corner (px)', 'woo-coupon-box' ),
            'input_attrs' => array(
                'min'  => 0,
                'step' => 1,
            ),
    ...
    protected function add_section_design_popup_icon( $wp_customize ) {
        $wp_customize->add_section( 'wcb_coupon_box_design_popup_icon', array(
            ...
            'capability'     => 'manage_options',
            'theme_supports' => '',
            'title'          => esc_html__( 'Popup Icons', 'woo-coupon-box' ),
            'panel'          => 'wcb_coupon_box_design',
        ) );
        ...
        $wp_customize->add_control( 'woo_coupon_box_params[wcb_popup_icon_enable]', array(
            ...
            'label'       => esc_html__( 'Coupon box icon', 'woo-coupon-box' ),
            'description' => esc_html__( 'A small icon to call coupon again after a visitor closes coupon box without subscribing', 'woo-coupon-box' ),
        ) );
        ...
        $wp_customize->add_control( 'woo_coupon_box_params[wcb_popup_icon_mobile]', array(
            'type'        => 'checkbox',
            'section'     => 'wcb_coupon_box_design_popup_icon',
            'label'       => esc_html__( 'Coupon box icon on mobile', 'woo-coupon-box' ),
            'description' => esc_html__( 'Uncheck this to hide the coupon box icon on mobile', 'woo-coupon-box' ),
        ) );
        ...
        $wp_customize->add_control( 'woo_coupon_box_params[wcb_popup_icon_position]', array(
            ...
            'label'   => esc_html__( 'Icon position', 'woo-coupon-box' ),
            'choices' => array(
                'top-left'     => esc_html__( 'Top Left', 'woo-coupon-box' ),
                'top-right'    => esc_html__( 'Top Right', 'woo-coupon-box' ),
                'bottom-left'  => esc_html__( 'Bottom Left', 'woo-coupon-box' ),
                'bottom-right' => esc_html__( 'Bottom Right', 'woo-coupon-box' ),
        ...
        $wp_customize->add_control( 'woo_coupon_box_params[wcb_popup_icon_border_radius]', array(
            'type'        => 'number',
            'section'     => 'wcb_coupon_box_design_popup_icon',
            'label'       => esc_html__( 'Icon wrap rounded corner(px)', 'woo-coupon-box' ),
            'input_attrs' => array(
                'min'  => 0,
                'step' => 1,
            ),
        ...
        $wp_customize->add_control( new WOO_COUPON_BOX_Alpha_Color_Control( $wp_customize, 'woo_coupon_box_params[wcb_popup_icon_color]', array(
            'label'        => esc_html__( 'Icon color', 'woo-coupon-box' ),
            'section'      => 'wcb_coupon_box_design_popup_icon',
            'show_opacity' => true, // Optional.
            'palette'      => array(
        ...
        $wp_customize->add_control( new WOO_COUPON_BOX_Alpha_Color_Control( $wp_customize, 'woo_coupon_box_params[wcb_popup_icon_bg_color]', array(
            'label'        => esc_html__( 'Icon background color', 'woo-coupon-box' ),
            'section'      => 'wcb_coupon_box_design_popup_icon',
            'show_opacity' => true, // Optional.
            'palette'      => array(
                'rgb(0, 0, 0)',
        ...
        $wp_customize->add_control( new WOO_COUPON_BOX_Radio_Icons_Control( $wp_customize, 'woo_coupon_box_params[wcb_popup_icon]', array(
            'label'   => 'Icons',
            'section' => 'wcb_coupon_box_design_popup_icon',
            'choices' => array(
    ...
    protected function add_section_design_custom_css( $wp_customize ) {
        $wp_customize->add_section( 'wcb_coupon_box_design_custom_css', array(
            ...
            'capability'     => 'manage_options',
            'theme_supports' => '',
            'title'          => esc_html__( 'Custom CSS', 'woo-coupon-box' ),
            'panel'          => 'wcb_coupon_box_design',
        ) );
        ...
        $wp_customize->add_control( 'woo_coupon_box_params[wcb_custom_css]', array(
            ...
            'label'    => esc_html__( 'Custom CSS', 'woo-coupon-box' ),
        ) );
    }
